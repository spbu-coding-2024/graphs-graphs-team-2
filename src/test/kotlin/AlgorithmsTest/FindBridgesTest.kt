...
class FindBridgesTest {
    ...
    /**
     * test accepts a randomly generated graph, all bridges are calculated during generation.
     * when creating a graph, a certain number of connectivity components are generated and 1 edge is laid between them.
     * the test checks the correctness of the bridges generated by the algorithm.
     */
