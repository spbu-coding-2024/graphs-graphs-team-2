...
class Application {
    ...
    @Bean
    fun databaseInitializer(graphRepository: GraphRepository) = ApplicationRunner {
        if(graphRepository.count() == 0L){
            val v1 = VertexNeo4j(Pair(50.dp,50.dp))
            val v2 = VertexNeo4j(Pair(100.dp,10.dp))
            val v3 = VertexNeo4j(Pair(200.dp,20.dp))
